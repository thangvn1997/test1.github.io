                ...
                <div class="col-xs-12  col-sm-12 col-md-12 col-lg-9" style="float: left">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <!-- Preview Image -->
                            <img src="upload/dichvu/{{$dichvu1->hinhanh}}" width="220px" height="130px" style="text-align: center" alt="" />
                            <!-- Date/Time -->
                            <p><span class="glyphicon glyphicon-time"></span> Posted on {{$dichvu1->updated_at}}</p>
                            <p>{!!$dichvu1->noidung!!}</p>
                        </div>
                    </div>
                </div>
